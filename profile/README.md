...
|---|---|---|---|
| [Bolic.App](https://github.com/bolic-ca/Bolic.App) | The mobile app | React Native, Expo, TypeScript | MIT |
| [Bolic.Backend](https://github.com/bolic-ca/Bolic.Backend) | Sync API and server-side logic | C#, Azure Functions, LanguageExt | AGPL-3.0 |
| [Bolic.Shared](https://github.com/bolic-ca/Bolic.Shared) | Shared types and contracts between backend services | C# | MIT |
...
Questions, bug reports, or just curious? Open an issue on the relevant repo, or reach out at [support@bolic.ca](mailto:support@bolic.ca).
